function validateEmailForm() {
    ...
    function isEmailValid(email) {
        ...
        // Validating both local and domain parts
    ...
    function isValidLocalPart(localPart) {
        ...
        // Checking each character in the local part
    ...
    // Validating the domain part of the email
    function isValidDomainPart(domainPart) {
        ...
        // Checking for consecutive dots in the domain
